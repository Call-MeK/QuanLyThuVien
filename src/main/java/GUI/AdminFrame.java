...
public class AdminFrame extends JFrame {
    ...
    private JTree menuTree; // Thay thế các JButton rời rạc
    ...
    private void initComponents() {
        ...
        // Header của Menu (Giữ lại phần hiển thị tên Admin)
        ...
        String tenHienThi = SessionManager.getInstance().isLoggedIn() ? SessionManager.getInstance().getHoTen() : maNVDangNhap;
        ...
        root.add(nodeQuanLy); // Thêm node cha vào root
        ...
        menuTree.setRowHeight(40); // Tăng chiều cao để dễ bấm trên màn hình Admin

        // Custom giao diện cho Tree
        ...
        // Có thể thay đổi icon tại đây nếu muốn
