...
public class PhieuPhatBUS {
    ...
    // 1. Lấy toàn bộ danh sách phiếu phạt (DAO đã tự động chỉ lấy những phiếu chưa
    // bị xóa mềm)
    ...
    // 5. Xóa mềm phiếu phạt (Chỉ cần gọi DAO vì DAO đã đổi thành lệnh UPDATE
    // TrangThai = 0)
    ...
    public String taoPhieuPhat(PhieuPhatDTO phieuPhat, ArrayList<ChiTietPhieuPhatDTO> dsChiTiet) {
        ...
        if (themChaThanhCong) {
            ...
            return "Tạo phiếu phạt thành công"; // Tạo phiếu phạt hoàn tất và thành công!
        }
